...
import type {
  ISafeNFT,
  ISafeNFTInterface,
} from "../../../contracts/interfaces/ISafeNFT";
...
export class ISafeNFT__factory {
  ...
  static createInterface(): ISafeNFTInterface {
    return new utils.Interface(_abi) as ISafeNFTInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISafeNFT {
    return new Contract(address, _abi, signerOrProvider) as ISafeNFT;
  }
}
